...
- **OpenTelemetry** (medium) — watchlist-not-on-card; stars=4316; Tracked in watchlist but not present on the public card
  - docs: https://opentelemetry.io/docs/
  - repo: https://github.com/open-telemetry/opentelemetry-specification
- **Argo CD** (high) — watchlist-not-on-card; stars=23965; Tracked in watchlist but not present on the public card
  - docs: https://argo-cd.readthedocs.io/
  - repo: https://github.com/argoproj/argo-cd
- **Flux** (high) — watchlist-not-on-card; stars=8360; Tracked in watchlist but not present on the public card
...
- **OpenFeature** (medium) — watchlist-not-on-card; stars=1240; Tracked in watchlist but not present on the public card
  - docs: https://openfeature.dev/docs/reference/intro
  - repo: https://github.com/open-feature/spec
- **90DaysOfDevOps** (high) — github-search-novel; stars=29663; This repository started out as a learning in public project for myself and has now become a structured learning map for many in the community. We have 3 years under our belt covering all things DevOps, including Principles, Processes, Tooling and Use Cases surrounding this vast topic. 
  - docs: https://www.90daysofdevops.com/
  - repo: https://github.com/MichaelCade/90DaysOfDevOps
- **argo-workflows** (high) — github-search-novel; stars=16923; Workflow Engine for Kubernetes
...
- **digger** (high) — github-search-novel; stars=5026; Digger is an open source IaC orchestration tool. Digger allows you to run IaC in your existing CI pipeline ⚡️  
  - docs: https://digger.dev
  - repo: https://github.com/diggerhq/digger
- **werf** (high) — github-search-novel; stars=4717; A solution for implementing efficient and consistent software delivery to Kubernetes facilitating best practices.
  - docs: https://werf.io
  - repo: https://github.com/werf/werf
- **jx** (high) — github-search-novel; stars=4689; Jenkins X provides automated CI+CD for Kubernetes with Preview Environments on Pull Requests using Cloud Native pipelines from Tekton
  - docs: https://jenkins-x.io/
  - repo: https://github.com/jenkins-x/jx

## Fresh releases

- **Bicep** v0.46.1 (21d ago)
- **Terraform** v1.15.9 (1d ago)
- **OpenTelemetry** v1.60.0 (13d ago) — not on card
- **Argo CD** v3.5.1 (9d ago) — not on card
- **Flux** v2.9.4 (13d ago) — not on card
