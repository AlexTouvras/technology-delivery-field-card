...
- **OpenFeature** (medium) — watchlist-not-on-card; stars=1248; Tracked in watchlist but not present on the public card
...
- **jx** (high) — github-search-novel; stars=4691; Jenkins X provides automated CI+CD for Kubernetes with Preview Environments on Pull Requests using Cloud Native pipelines from Tekton
